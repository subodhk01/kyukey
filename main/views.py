...
class index(PermissionRequiredMixin, generic.ListView):
    """
    ...
    paginate_by = 12  # By how many objects this has to be paginated
    title = _("Overview")  # This is used for title and heading
