...
class Reservation(models.Model):
    ...
    staff = models.ForeignKey(Staff, on_delete=models.CASCADE, editable=False, null=True)
...
class Lock(models.Model):
    lock_id = models.CharField(primary_key=True, max_length=10)
...
class Room(models.Model):
    ...
    check_in = models.ForeignKey('payment.CheckIn', null=True, on_delete=models.CASCADE)
    check_out = models.ForeignKey('payment.CheckOut', null=True, on_delete=models.CASCADE)
